...
public class Film {
    ...
    public String toString() {
        return "Film: " +
                ...
                ", special features: " + listSpecialFeatures() +
                " full text: " + listFullText();
    }

    private String listFullText() {
        return fullText.stream().map(s -> s.concat(", ")).collect(Collectors.joining());
    }

    private String listSpecialFeatures() {
        return specialFeatures.stream().map(s -> s.concat(", ")).collect(Collectors.joining());
    }
}
